...
def arg_parse():
    ...
    parser.add_argument('--teacher_epochs', type=int, default=20, help='epochs of finetune pretrain model')
    parser.add_argument('--student_epochs', type=int, default=20, help='epochs of training student')
