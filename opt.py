...
def arg_parse():
    ...
    # dir
    parser.add_argument('--save_model_dir', type=str, default=os.path.join('trained_model', 'resnet18'), help='save_model_dir')
    ...
    # train
    parser.add_argument('--pretrain', type=bool, default=False, help='If your model need pretrain, set True')
    ...
    parser.add_argument('--student_epochs', type=int, default=1, help='epochs of training student')
